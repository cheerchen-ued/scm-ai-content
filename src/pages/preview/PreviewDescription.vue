		...
		return {
			...
			aiProdDescSuggestions: [
				'築地市場是東京最具代表性的海鮮市場之一，這趟行程將由在地嚮導帶領，穿梭於熱鬧的場外市場，認識當令漁獲與職人文化，最後在市場內的老字號壽司店享用職人現捏的握壽司早餐，感受東京清晨最鮮活的一面。\n\n' +
					...
					'行程中會特別安排一段「職人講堂」，由壽司師傅親自示範如何辨別當日最肥美的鮪魚部位、如何以溫度與手勁捏出恰到好處的醋飯，並讓每位旅客親手體驗握一貫屬於自己的壽司，是攝影與打卡的最佳時刻。\n\n' +
					'除了品嘗與體驗，嚮導也會分享許多只有在地人才知道的隱藏名店：從排隊也值得的玉子燒老舖、現烤星鰻串，到用整條鮪魚骨熬煮的味噌湯攤，讓旅客一次走遍築地最經典的味覺地標，不必自己做功課也能吃得道地。\n\n' +
					'行程全程使用中文導覽，適合三到六人的小團體，且已包含壽司早餐費用，無需另外準備現金；若遇雨天，多數攤位與店家皆位於有頂棚的巷弄內，行程照常出發，旅客可安心參加。\n\n' +
					'貼心提醒：市場走道濕滑、人潮眾多，建議穿著好走的防滑鞋款，並自備一支環保購物袋，方便將採買的乾貨、海苔與伴手禮一次帶回飯店。',
				'跟著擁有十年經驗的在地嚮導，走進築地市場的日常。從鮪魚拍賣區的緊張氣氛，到蔬果、乾貨攤位的討價還價，每一站都有嚮導的中文解說，讓你不只是走馬看花，而是真正理解這座百年市場的運作方式。\n\n' +
					'這位嚮導本身出身於築地魚商世家，對市場裡每一間老字號的故事都如數家珍，帶團時會特別繞到幾間僅供批發、不對外開放參觀的乾貨行，讓旅客近距離觀察職人如何分級與秤重，體會一條好魚從產地到餐桌的完整旅程。\n\n' +
					'行程中段會安排一段約十五分鐘的自由採買時間，讓有興趣的旅客可以直接跟攤商互動、購買新鮮海苔或柴魚片等伴手禮，嚮導也會在一旁協助翻譯與議價，就算不會日文也能買得盡興、買得安心。\n\n' +
					'午餐時段，嚮導會依當日漁獲狀況推薦兩到三家風格各異的店家：想吃講究的可以選職人壽司，想吃豪邁的則有滿滿一碗的海鮮丼，也有適合怕生食旅客的星鰻與玉子燒定食，讓同行的每個人都能找到喜歡的口味。\n\n' +
					'餐後，行程會帶大家走一小段到隱身巷弄的百年神社與刀具老街，聽嚮導講述築地與江戶飲食文化的淵源，替這趟味覺之旅補上一段人文風景，也讓照片裡不只有食物，還有故事。\n\n' +
					'整趟行程步行距離約兩公里，全程輕鬆好走，建議穿著好走的鞋子並自備一支環保購物袋；若當天有當季限定的漁獲上市，嚮導也會彈性調整路線，優先帶大家前往，讓每一梯次都保有新鮮感與獨特性。',
			],
